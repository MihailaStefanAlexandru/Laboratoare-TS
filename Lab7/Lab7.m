function y = read_io_data

    y = readtable('date_identificare.xlsx');
...
function [K, T, Td] = get_experimental_model(u0, us, y0, ys, tu0, ty0, ty63)
...
[K, T, Tdelta] = get_experimental_model(u0, us, y0, ys, tu0, ty0, ty63);
